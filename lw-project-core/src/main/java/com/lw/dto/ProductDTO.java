...
public class ProductDTO extends BaseDTO {
    ...
    private static final long serialVersionUID = 948714325657160046L;
     ...
     * 组合明细
     */
    private List<ProductAssembleDTO> subList = new ArrayList<>();

    /**
     * 分类列表
     */
    private List<ProductClassifyDTO> classifyList = new ArrayList<>();

    /**
     * 产品来源列表
     */
    private List<ProductSourceDTO> sourceList = new ArrayList<>();
}
